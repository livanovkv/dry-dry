    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".swiper")) {
                console.log("есть слайдер на главной");
                new core(".swiper", {
                    modules: [ Navigation, Autoplay, Parallax, Lazy ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
                    spaceBetween: 0,
        ...
        function dryFilter() {
            ...
            function filter(category, items) {
                items.forEach((item => {
                    ...
                    if (isItemFiltered && !isShowAll) item.classList.add("product-card_anime"); else {
            ...
            cards.forEach((card => {
                card.ontransitionend = function() {
                    if (card.classList.contains("product-card_anime")) card.classList.add("product-card_hide");
                };
            }));
        }
        dryFilter();
        ...
        convert.map((function(e) {
            ...
            function counterup() {
                ...
                if (counterNumber == e.dataset.number) clearInterval(timing);
            }
